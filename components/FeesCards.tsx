...
const DEFAULTS: FeesSettings = {
  courseFee: "5000", deadline: "", discountPercent: "20", offeredAmount: "4000", paymentNo: "01744876993 (bKash/Nagad)",
  mcqCourseFee: "1500", mcqDeadline: "", mcqDiscountPercent: "15", mcqOfferedAmount: "1275", mcqPaymentNo: "01744876993 (bKash/Nagad)",
  mcqCardVisible: true,
};
...
export default function FeesCards() {
  ...
  const showMcqCard = fees.mcqCardVisible !== false; // default visible unless explicitly hidden
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-6 flex flex-wrap justify-center gap-6">
      ...
      >
        ...
        <p className="mb-4">আগামী <b>{formatBnDate(fees.deadline) || "শীঘ্রই ঘোষণা হবে"}</b> এর মধ্যে ভর্তি হলে</p>
      ...
      {showMcqCard && (
        ...
        >
          ...
          <p className="mb-4">আগামী <b>{formatBnDate(fees.mcqDeadline) || "শীঘ্রই ঘোষণা হবে"}</b> এর মধ্যে ভর্তি হলে</p>
          <span className="inline-block bg-black/30 rounded-lg px-4 py-2 text-xl font-bold mb-4">
